 ...
 */
@protocol ETDSAuthenticationResponse <NSObject>

/// Universally unique transaction identifier assigned by the 3DS Server to identify a single transaction.
@property (nonatomic, readonly) NSString *threeDSServerTransactionID;

/// Transaction status
@property (nonatomic, readonly) ETDSACSStatusType status;
...
/// A utility to parse an ETDSAuthenticationResponse from JSON
id<ETDSAuthenticationResponse> _Nullable ETDSAuthenticationResponseFromJSON(NSDictionary *json);
