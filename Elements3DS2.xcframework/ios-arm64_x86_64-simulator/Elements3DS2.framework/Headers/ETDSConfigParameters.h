 ...
 */
extern NSString * const kETDSConfigDefaultGroupName;

/**
 `ETDSConfigParameters` represents additional configuration parameters
 ...
 just pass `[ETDSConfigParameters alloc] initWithStandardParameters`
 to the `ETDSThreeDS2Service` instance.
 */
@interface ETDSConfigParameters : NSObject

/**
 Convenience initializer to get an `ETDSConfigParameters` instance
...
/**
 ...
 @param paramGroup The group to which this parameter will be added. If `nil` the parameter will be added to `kETDSConfigDefaultGroupName`

 @exception ETDSInvalidInputException Will throw an `ETDSInvalidInputException` if `paramName` or `paramValue` are `nil`. @see ETDSInvalidInputException
 */
...
/**
 ...
 @param paramGroup The group from which to fetch the parameter value. If `nil` will default to `kETDSConfigDefaultGroupName`

 @exception ETDSInvalidInputException Will throw an `ETDSInvalidInputException` if `paramName` is `nil`. @see ETDSInvalidInputException
 */
...
/**
 ...
 @param paramGroup The group from which to remove this parameter. If `nil` will default to `kETDSConfigDefaultGroupName`
