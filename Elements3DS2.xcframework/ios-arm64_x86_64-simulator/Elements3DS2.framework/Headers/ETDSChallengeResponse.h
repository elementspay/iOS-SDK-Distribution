...
/**
 The `ETDSACSUIType` enum defines the type of UI to be presented.
 */
typedef NS_ENUM(NSInteger, ETDSACSUIType) {
    ...
    ETDSACSUITypeSingleSelect = 2,
    
    /// Multi-select challenge response UI.
    ETDSACSUITypeMultiSelect = 3,
...
@property (nonatomic, readonly) ETDSACSUIType acsUIType;
...
@property (nonatomic, readonly, nullable) NSArray<id<ETDSChallengeResponseSelectionInfo>> *challengeSelectInfo;
...
@property (nonatomic, readonly, nullable) id<ETDSChallengeResponseImage> issuerImage;
...
@property (nonatomic, readonly, nullable) NSArray<id<ETDSChallengeResponseMessageExtension>> *messageExtensions;
...
@property (nonatomic, readonly, nullable) id<ETDSChallengeResponseImage> paymentSystemImage;
