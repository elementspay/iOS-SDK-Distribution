//
//  ETDSNavigationBarCustomization.h
//  Stripe3DS2
//
...
/**
 ...
 The font and textColor inherited from `ETDSCustomization` configure the
 title of the navigation bar, and default to nil.
 */
@interface ETDSNavigationBarCustomization : ETDSCustomization
