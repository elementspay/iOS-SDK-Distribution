 ...
 */
+ (NSLayoutConstraint *)_etds_topConstraintWithItem:(id)view1 toItem:(id)view2;
 ...
 */
+ (NSLayoutConstraint *)_etds_leftConstraintWithItem:(id)view1 toItem:(id)view2;
 ...
 */
+ (NSLayoutConstraint *)_etds_rightConstraintWithItem:(id)view1 toItem:(id)view2;
 ...
 */
+ (NSLayoutConstraint *)_etds_bottomConstraintWithItem:(id)view1 toItem:(id)view2;

@end

NS_ASSUME_NONNULL_END

void _etds_import_nslayoutconstraint_layoutsupport(void);
