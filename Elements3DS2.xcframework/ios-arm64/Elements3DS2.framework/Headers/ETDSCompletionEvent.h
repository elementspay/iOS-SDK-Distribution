...
/**
 `ETDSCompletionEvent` contains information about completion of the challenge process.
 */
@interface ETDSCompletionEvent : NSObject

/**
 Designated initializer for `ETDSCompletionEvent`.
 */
...
/**
 `ETDSCompletionEvent` should not be directly initialized.
 */
