//
//  ETDSAuthenticationRequestParameters.h
//  Stripe3DS2
//
...
@interface ETDSAuthenticationRequestParameters : NSObject <ETDSJSONEncodable>

/**
 Designated initializer for `ETDSAuthenticationRequestParameters`.
 
 @param sdkTransactionIdentifier    The SDK Transaction Identifier, as created by `[ETDSTransaction createTransaction]`
