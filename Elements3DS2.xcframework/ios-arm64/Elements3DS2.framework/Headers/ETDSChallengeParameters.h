...
@protocol ETDSAuthenticationResponse;

NS_ASSUME_NONNULL_BEGIN

/**
 `ETDSChallengeParameters` contains information from the 3DS Server's
 authentication response that are used by the 3DS2 SDK to initiate
 the challenge flow.
 */
@interface ETDSChallengeParameters : NSObject

/**
 Convenience intiializer to create an instace of `ETDSChallengeParameters` from an
 `ETDSAuthenticationResponse`
 */
- (instancetype)initWithAuthenticationResponse:(id<ETDSAuthenticationResponse>)authResponse;
