...
@interface BDListSectionController : NSObject
...
/**
 ...
 one of the dequeue methods on the BDListCollectionContext. The default implementation will assert. **You must override
 ...
 `-cellForItemAtIndex:sectionController:` on `BDListCollectionContext` to obtain active cell references.
 */
...
/**
 ...
 after initialization. We bridge it to Swift as an implicitly-unwrapped Optional, so that idiomatic BDListKit
 ...
 */
@property (nonatomic, weak, null_unspecified, readonly) id <BDListCollectionContext> collectionContext;
...
/**
 ...
 @return An object that conforms to `BDListSupplementaryViewSource` or `nil`.

 @note You may wish to return `self` if your section controller implements this protocol.
 */
@property (nonatomic, weak, nullable) id <BDListSupplementaryViewSource> supplementaryViewSource;

/**
 An object that handles display events for the section controller. Can be `nil`.

 @return An object that conforms to `BDListDisplayDelegate` or `nil`.

 @note You may wish to return `self` if your section controller implements this protocol.
 */
@property (nonatomic, weak, nullable) id <BDListDisplayDelegate> displayDelegate;

/**
 An object that handles working range events for the section controller. Can be `nil`.

 @return An object that conforms to `BDListWorkingRangeDelegate` or `nil`.

 @note You may wish to return `self` if your section controller implements this protocol.
 */
@property (nonatomic, weak, nullable) id <BDListWorkingRangeDelegate> workingRangeDelegate;

/**
 An object that handles scroll events for the section controller. Can be `nil`.

 @return An object that conforms to `BDListScrollDelegate` or `nil`.

 @note You may wish to return `self` if your section controller implements this protocol.
 */
@property (nonatomic, weak, nullable) id <BDListScrollDelegate> scrollDelegate;

/**
 An object that handles transition events for the section controller. Can be `nil`.

 @return An object that conforms to `BDListTransitionDelegat` or `nil`.

 @note You may wish to return `self` if your section controller implements this protocol.
 */
@property (nonatomic, weak, nullable) id<BDListTransitionDelegate> transitionDelegate;
