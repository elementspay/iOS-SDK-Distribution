...
/**
 The `BDListDiffable` protocol provides methods needed to compare the identity and equality of two objects.
 */
 ...
 */
- (BOOL)isEqualToDiffableObject:(nullable id<BDListDiffable>)object;
