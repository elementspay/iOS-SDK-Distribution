...
/**
 An instance of `BDListBatchUpdateData` takes section indexes and item index paths
...
@interface BDListBatchUpdateData : NSObject
...
/**
 Section moves.
 */
@property (nonatomic, strong, readonly) NSSet<BDListMoveIndex *> *moveSections;
...
/**
 Item moves.
 */
@property (nonatomic, strong, readonly) NSArray<BDListMoveIndexPath *> *moveIndexPaths;
...
- (instancetype)initWithInsertSections:(NSIndexSet *)insertSections
                        deleteSections:(NSIndexSet *)deleteSections
                          moveSections:(NSSet<BDListMoveIndex *> *)moveSections
                      ...
                      updateIndexPaths:(NSArray<NSIndexPath *> *)updateIndexPaths
                        moveIndexPaths:(NSArray<BDListMoveIndexPath *> *)moveIndexPaths NS_DESIGNATED_INITIALIZER;
