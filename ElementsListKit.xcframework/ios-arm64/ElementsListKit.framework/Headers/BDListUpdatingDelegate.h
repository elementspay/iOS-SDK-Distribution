...
typedef void (^BDListUpdatingCompletion)(BOOL finished);
...
typedef void (^BDListTransitionDataApplyBlock)(BDListTransitionData *data);
...
@protocol BDListUpdatingDelegate <NSObject>
 ...
 */
- (void)performUpdateWithCollectionViewBlock:(BDListCollectionViewBlock)collectionViewBlock
                                    animated:(BOOL)animated
                            sectionDataBlock:(BDListTransitionDataBlock)sectionDataBlock
                       applySectionDataBlock:(BDListTransitionDataApplyBlock)applySectionDataBlock
                                  completion:(nullable BDListUpdatingCompletion)completion;
...
- (void)performUpdateWithCollectionViewBlock:(BDListCollectionViewBlock)collectionViewBlock
                                    animated:(BOOL)animated
                                 itemUpdates:(BDListItemUpdateBlock)itemUpdates
                                  completion:(nullable BDListUpdatingCompletion)completion;
 ...
 */
- (void)performDataSourceChange:(BDListDataSourceChangeBlock)block;
 ...
 */
- (void)reloadDataWithCollectionViewBlock:(BDListCollectionViewBlock)collectionViewBlock
                        reloadUpdateBlock:(BDListReloadUpdateBlock)reloadUpdateBlock
                               completion:(nullable BDListUpdatingCompletion)completion;
