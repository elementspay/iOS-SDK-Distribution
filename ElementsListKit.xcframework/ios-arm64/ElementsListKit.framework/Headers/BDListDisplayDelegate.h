...
@protocol BDListDisplayDelegate <NSObject>
 ...
 */
- (void)listAdapter:(BDListAdapter *)listAdapter willDisplaySectionController:(BDListSectionController *)sectionController;
 ...
 */
- (void)listAdapter:(BDListAdapter *)listAdapter didEndDisplayingSectionController:(BDListSectionController *)sectionController;
