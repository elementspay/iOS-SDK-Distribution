...
@protocol BDListScrollDelegate <NSObject>
 ...
 */
- (void)listAdapter:(BDListAdapter *)listAdapter didScrollSectionController:(BDListSectionController *)sectionController;
 ...
 */
- (void)listAdapter:(BDListAdapter *)listAdapter willBeginDraggingSectionController:(BDListSectionController *)sectionController;
 ...
 */
- (void)listAdapter:(BDListAdapter *)listAdapter didEndDraggingSectionController:(BDListSectionController *)sectionController willDecelerate:(BOOL)decelerate;
 ...
 */
- (void)listAdapter:(BDListAdapter *)listAdapter didEndDeceleratingSectionController:(BDListSectionController *)sectionController;
