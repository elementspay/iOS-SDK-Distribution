...
#import <ElementsListKit/BDListCollectionScrollingTraits.h>
...
@protocol BDListCollectionContext <NSObject>
 ...
 */
@property (nonatomic, readonly) BDListCollectionScrollingTraits scrollingTraits;
 ...
 */
- (CGSize)containerSizeForSectionController:(BDListSectionController *)sectionController;
...
- (NSInteger)indexForCell:(UICollectionViewCell *)cell
        sectionController:(BDListSectionController *)sectionController;
 ...
 */
- (NSArray<UICollectionViewCell *> *)fullyVisibleCellsForSectionController:(BDListSectionController *)sectionController;
 ...
 */
- (NSArray<UICollectionViewCell *> *)visibleCellsForSectionController:(BDListSectionController *)sectionController;
 ...
 */
- (NSArray<NSIndexPath *> *)visibleIndexPathsForSectionController:(BDListSectionController *) sectionController;
...
- (__kindof UICollectionViewCell *)dequeueReusableCellOfClass:(Class)cellClass
                                         ...
                                         forSectionController:(BDListSectionController *)sectionController
 ...
 */
- (void)invalidateLayoutForSectionController:(BDListSectionController *)sectionController
...
/**
 ...
 ```
 [self.collectionContext performBatchItemUpdates:^ (id<BDListBatchContext> batchContext>){
...
- (void)performBatchAnimated:(BOOL)animated
                     updates:(void (^)(id<BDListBatchContext> batchContext))updates
                  completion:(nullable void (^)(BOOL finished))completion;
 ...
 */
- (void)scrollToSectionController:(BDListSectionController *)sectionController
                          atIndex:(NSInteger)index
                   scrollPosition:(UICollectionViewScrollPosition)scrollPosition
                         animated:(BOOL)animated;
