...
/**
 Conform to `BDListTransitionDelegate` to provide customized layout information for a collection view.
 */
@protocol BDListTransitionDelegate <NSObject>
 ...
 */
- (UICollectionViewLayoutAttributes *)listAdapter:(BDListAdapter *)listAdapter customizedInitialLayoutAttributes:(UICollectionViewLayoutAttributes *)attributes sectionController:(BDListSectionController *)sectionController atIndex:(NSInteger)index;
 ...
 */
- (UICollectionViewLayoutAttributes *)listAdapter:(BDListAdapter *)listAdapter customizedFinalLayoutAttributes:(UICollectionViewLayoutAttributes *)attributes sectionController:(BDListSectionController *)sectionController atIndex:(NSInteger)index;
