...
/**
 Conform to `BDListCollectionViewDelegateLayout` to provide customized layout information for a collection view.
 */
@protocol BDListCollectionViewDelegateLayout <UICollectionViewDelegateFlowLayout>
