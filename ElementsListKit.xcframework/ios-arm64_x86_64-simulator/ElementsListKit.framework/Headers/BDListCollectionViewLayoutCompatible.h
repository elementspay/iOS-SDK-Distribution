...
/**
 A protocol for layouts that defines interaction with an BDListCollectionView, for recieving updated section indexes.
 */
NS_SWIFT_NAME(ListCollectionViewLayoutCompatible)
@protocol BDListCollectionViewLayoutCompatible <NSObject>
...
/**
 ...
 actually needs to be updated on the following `-invalidateLayoutWithContext`. See `BDListCollectionView`.
