...
@interface BDListIndexPathResult : NSObject
 ...
 */
@property (nonatomic, copy, readonly) NSArray<BDListMoveIndexPath *> *moves;
...
/**
 ...
 @see `-[BDListDiffable diffIdentifier]`.
 */
 ...
 */
- (BDListIndexPathResult *)resultForBatchUpdates;
